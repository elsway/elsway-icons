...
Files
  autonaut-default.ttf       the icon font
  autonaut-default.woff      same font, web-optimised
  autonaut-default.css       helper classes
...
Web
  ...
  2. <link rel="stylesheet" href="autonaut-default.css">
  3. <i class="ai-heart-fill"></i>

Anywhere else (Figma, Sketch, native apps)
  Install autonaut-default.ttf and type the glyph's codepoint.
