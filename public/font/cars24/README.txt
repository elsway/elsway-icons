...
Files
  autonaut-cars24.ttf       the icon font
  autonaut-cars24.woff      same font, web-optimised
  autonaut-cars24.css       helper classes
...
Web
  ...
  2. <link rel="stylesheet" href="autonaut-cars24.css">
  3. <i class="ai-heart-fill"></i>

Anywhere else (Figma, Sketch, native apps)
  Install autonaut-cars24.ttf and type the glyph's codepoint.
